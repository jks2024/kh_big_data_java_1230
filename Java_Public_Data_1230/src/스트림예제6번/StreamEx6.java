...
// 스트림 최종 연산 : 중개 연산을 통해 변환된 스트림은 마직막으로 최종 연산을 통해 요소를 소모해 결과를 출력
public class StreamEx6 {
    public static void main(String[] args) {
        ...
        // reduce() : 첫 번째 요소와 두 번째 요소를 가지고 연산을 수행 후, 그 결과롸 세번째 요소를 가지고 다시 연산
...
//        rst1.ifPresent(System.out::println);
        ...
        OptionalInt rst3 = stream5.sorted().findAny(); // 병렬처리 관련 내용이 포함되어 있어서 요소의 첫번째 값이 아닌 경우가 있음
